# vbwd-plugin-checkout

> Checkout flow CMS seeder — shared by every billing-completing plugin (shop, booking, subscription)

**Type:** Backend plugin · **Host app:** `vbwd-backend` · **Plugin:** `checkout`
